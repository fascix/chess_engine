...
// Chaque droit de roque est représenté par un seul bit (vu sous une puissance
// de 2). 0x01=0001, 0x02=0010, 0x04=0100, 0x08=1000 → Cela permet de combiner
...
typedef struct {
  ...
  // Hash Zobrist incrémental (pour table de transposition)
